...
public class RoadAddress {
	...
	public String toString() {
		...
		builder.append("RoadAddress [address_name=");
		...
		builder.append(road_name);
		builder.append(", underground_yn=");
		builder.append(underground_yn);
		builder.append(", main_building_no=");
		builder.append(main_building_no);
		builder.append(", sub_building_no=");
		builder.append(sub_building_no);
		builder.append(", building_name=");
		builder.append(building_name);
		builder.append(", zone_no=");
		builder.append(zone_no);
		builder.append("]");
